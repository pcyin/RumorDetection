...
public abstract class SqlHelper
{
    ...
    public static readonly string ConnectionStringLocalTransaction = @"Data Source=(local)\SQLEXPRESS;Initial Catalog=WeiBoFalseMsg;User ID=sa;Password=lunalovegood";
    ...
    {
        return ExecuteScalar(SqlHelper.ConnectionStringLocalTransaction, CommandType.Text, cmdText, commandParameters);
    }
